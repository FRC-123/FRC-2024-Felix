...
public final class Constants {
  ...
  public static class HiArmConstants {
    public static int HIARM_MOTOR_CANID = 12;
    public static int HIROLLER_MOTOR_CANID = 11;
  }

  public static class LoArmConstants {
    public static int LOARM_MOTOR_CANID = 9;
    public static int LOROLLER_MOTOR_CANID = 10
    ;
  }
